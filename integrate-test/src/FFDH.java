...
class FFDH {
    ...
    public static ArrayList<Box2> setBoxesPositions(ArrayList<Box2> boxes, float boardheight) {
        ...
        for(i = 1; i < boxes.size(); i++) {
            if(boxes.get(i).getLevel() == boxes.get(i - 1).getLevel()) {
            ...
            } else if(boxes.get(i).getLength() + boxes.get(i-1).getPosy() <= boardheight){
            	...
            	// set to -1,-1 so it cannot render.
    ...
    public static void main(String[] args) {
        ...
        sqrs.add(new Box2(10, 10, 1, 0));
        sqrs.add(new Box2(50, 5, 1, 0));
        sqrs.add(new Box2(50, 50, 1, 0));
        sqrs.add(new Box2(10, 50, 1, 0));
        sqrs.add(new Box2(5, 5, 1, 0));
...
*/
        ...
        setBoxesPositions(sqrs, boardheight);
